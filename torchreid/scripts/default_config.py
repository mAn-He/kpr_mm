...
#     cfg.model.resume = "/home/hseung/keypoint_promptable_reidentification/train_outputs"  # path to checkpoint for resume training
...
#     # [MODIFIED] Text Prompt Configurations
#     cfg.model.text_prompt = CN()
#     cfg.model.text_prompt.enabled = False  # Enable text prompt fusion
#     cfg.model.text_prompt.train_json_path = ""  # Path to the training JSON file
#     cfg.model.text_prompt.query_json_path = ""  # Path to the query JSON file
#     cfg.model.text_prompt.gallery_json_path = "" # Optional: Path to a gallery JSON file if different descriptions are needed
#     cfg.model.text_prompt.clip_model_name = "ViT-B/32"  # CLIP model name
#     cfg.model.text_prompt.fusion_layer = 0 # Fuse after patch_embed + _mask_embed (keypoint prompt)
#     cfg.model.text_prompt.feature_dim_match = True # If true, attempts to match CLIP text feature dim to backbone patch_embed_dim via a Linear layer
...
#     cfg.data = CN()
#     cfg.data.type = "image"
#     cfg.data.root = "/home/hseung/keypoint_promptable_reidentification"
...
#     cfg.train.accumulation_steps = 5 # gradient accumulation steps
...
#     cfg.loss.supercon.enabled = False       # True일 때 SuperCon 합산
#     cfg.loss.supercon.temperature = 0.07    # Similarity scaling
#     cfg.loss.supercon.weight = 1.0         # SuperCon 가중치
...
#     cfg.loss.supercon.hard_mining_ratio = 0.5
#     cfg.loss.supercon.label_smooth = True
#     # test
#     cfg.test = CN()
#     cfg.test.batch_size = 8
#     cfg.test.batch_size_pairwise_dist_matrix = 100  # query to gallery distance matrix is computed on the GPU by batch of gallery samples with this size.
...
#     cfg.test.visrank_count = 5  # number of top-k ranks to plot
