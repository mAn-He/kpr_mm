...
#     def save_model(self, epoch, cmc, mAP, ssmd, save_dir, is_best=False, is_last = False):
...
#         self.best_mAP= 0
#         self.best_epoch=-1
#         last_rank_1, last_mAP, last_ssmd = 0, 0, 0
...
#                     self.save_model(epoch, rank_1, mAP, ssmd, save_dir, is_best=True, is_last=False)
#                 last_rank_1, last_mAP, last_ssmd = rank_1, mAP, ssmd
...
#                 evalate_on_sources_only=False
#             )
#             self.save_model(self.engine_state.epoch, rank_1, mAP, ssmd, save_dir, is_best=False, is_last=True)
