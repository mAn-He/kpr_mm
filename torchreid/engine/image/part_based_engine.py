...
#         ):
#             # 디버깅: 해상도 정보 출력
#             # print(f"Body part attention loss - pixels_cls_scores shape: {pixels_cls_scores.shape}")
#             # print(f"Body part attention loss - target_masks shape: {target_masks.shape}")
            
#             # 중요: target_masks를 pixels_cls_scores의 크기에 맞게 리사이징
#             # 이 부분이 주석 처리되어 있었지만, 텍스트 임베딩 추가로 인해 해상도가 달라졌으므로 필요합니다
