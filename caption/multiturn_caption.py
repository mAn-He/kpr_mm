...
DEFAULT_PROMPT = (
    ...
    "1) Their clothing with details (style, type) and colors "
    "2) Their physical characteristics – height category, body shape, limb/torso proportions, "
    "shoulder and hip width, gait style, posture, and any permanent anatomical markers. "
...
def parse_args():
    ...
    p.add_argument("--output_file", default="occlude_duke_bbx_multiturn_query.json")
