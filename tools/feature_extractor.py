...
class KPRFeatureExtractor(object):
    ...
    def __init__(
        ...
        # 텍스트 활성화 여부 저장
        self.text_enabled = hasattr(cfg.model, 'text_prompt') and cfg.model.text_prompt.enabled
    ...
    def __call__(self, input):
        ...
        for sample in samples:
            ...
            # 설명이 있고 텍스트가 활성화되어 있으면 추가
            if self.text_enabled and "description" in preprocessed_sample:
                batch["description"].append(preprocessed_sample["description"])
